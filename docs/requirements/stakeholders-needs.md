...
|                        | 4. Користувач знаходиться на сторінці свого профілю                             |
...
| **ОСНОВНІ СЦЕНАРІЇ:**  | 1. Користувач вводить дані                                                      |
|                        | 2. Система оброблює введені дані                                                |
|                        | 3. Користувач знаходиться на сторінці свого профілю                             |
...
|                        | 2. Сервер проводить перевірку на наявність виключних ситуацій                   |
|                        | 3. Клієнт на сторінці опитування(може покинути сайт, відповіді будуть збережені)|
...
| **ОСНОВНІ СЦЕНАРІЇ:**  | 1. Користувач вводить невірні дані                                              |
|                        | 2. Система ідентифікує дані як невірні                                          |
|                        | 3. Повідомлення про невірні дані або відсутність такого користувача             |
