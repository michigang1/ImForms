...
| **УЧАСНИКИ:**          | Гість (респондет), система                                                           | 
...
|                        | 3. Респондент на сторінці опитування(може покинути сайт, відповіді будуть збережені) |
...
| **РЕЗУЛЬТАТ:**         | Повідомлення про неправильно введені дані або відсутність такого користувача         |
| **ОСНОВНІ СЦЕНАРІЇ:**  | 1. Користувач вводить невірні дані                                                   |
|                        | 2. Система ідентифікує дані як невірні                                               |
|                        | 3. Система повідомляє про введення невірніх даних або відсутність такого користувача |
...
|                        | 3. Система повідомляє про пусте опитування                               |
...
| **УЧАСНИКИ:**          | Гість (респондент), система                                |
...
| **РЕЗУЛЬТАТ:**        | Повідомлення про відсутність відповідей на всі обов'язкові запитання          |
