...
| **ID:**                | INT.GET_GROUP                                                                       |
| ---------------------- |-------------------------------------------------------------------------------------|
| **НАЗВА:**             | Отримання отримання інформації про групу                                            |
| **УЧАСНИКИ:**          | Інтерв'юєр, система                                                                 |
| **ПЕРЕДУМОВИ:**        | Інтерв'юєр перебуває на сторінці свого профілю                                      |
...
|                        | 2. Респондент знаходиться на сторінці опитування (при виході відповіді зберігаються)|
|                        | 3. Респондент відповідає на запитання анкети                                        | 
|                        | 4. Респондент відправляє анкету до серверу                                          | 
|                        | 5. Система зберігає відповіді у базі даних                                          |
...
| **ОСНОВНІ СЦЕНАРІЇ:**  | 1. Користувач отримує опитування                                                    |
|                        | 2. Користувач відповів на всі питання отриманого опитування                         |
|                        | 3. Користувач надсилає результати опитування                                        |
|                        | 3. Cистема отримує і обробляє надіслані дані                                        |
...
| **УЧАСНИКИ:**         | Користувач, система                                                                  |
| **ПЕРЕДУМОВИ:**       | Користувач відправляє анкету на сторінці опитування                                  |
