...
|                        | 4. Інтерв'юеєр видаляє опитування за допомогую інструментарію сервісу               |
...
|                        | 3. Система оброблює запит                                                           |
|                        | 4. Інтерв'юеєр видаляє групу за допомогую інструментарію сервісу                    |
...
|                        | 3. Система оброблює запит                                                           |
|                        | 4.  Інтерв'юеєр видаляє учасника за допомогую інструментарію сервісу                |
