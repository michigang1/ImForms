...
|Система|
: Отримує запит;
: Відкриває модальне окно для підтвердження видалення опитування;
note left #ff0000
<b>Можлива</b>
...
|Інтерв'юер|
: Перенаправляється на сторінку з результатами опитування;
: Аналізує за допомогою інструментарію сервісу;
: Завершує взаємодію;
stop;
@enduml
...
|Користувач|
start
: Перебуває на сторінці опитувань;
: Натискає кнопку "Подивитись опитування";
...
|Система|
: Відкриває сторінку з інформацією про опитування;

|Користувач|
: Перебуває на сторінці з інформацією про опитування;
: Завершує взаємодію;
stop;
@enduml
...
|Система|
: Отримує запит;
: Відкриває модальне вікно з інформацією про групу;
